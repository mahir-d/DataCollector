class TableColumnName:
    ...
    Challenge_Member_Mapping = dict({
        "col_name_create": "challengeId VARCHAR(50),legacyId Int(255),memberHandle VARCHAR(50), submission Bool, winningPosition INT(255)",
        "col_name_insert": "challengeId, legacyId,memberHandle, submission, winningPosition"
    })
    Members = dict({
